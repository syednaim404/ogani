                                ...
                                <div class="latest-product__slider owl-carousel">
                                    <div class="latest-prdouct__slider__item">
                                        @foreach ($first_three as $first_three)
                                            <a href="{{ route('product.detail', $first_three->id) }}"
                                                class="latest-product__item">
                                                <div class="latest-product__item__pic">
                                                    <img src="{{ asset($first_three->image) }}"
                                                        alt="{{ $first_three->name }}">
                                                </div>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        @foreach ($next_three as $next_three)
                                            <a href="{{ route('product.detail', $first_three->id) }}"
                                                class="latest-product__item">
                                                <div class="latest-product__item__pic">
                                                    <img src="{{ asset($next_three->image) }}"
                                                        alt="{{ $next_three->name }}">
                                                </div>
                                                <div class="latest-product__item__text">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span>{{ $shops->count() }}</span> Products found</h6>
                                </div>
                            </div>
                        ...
                        @foreach ($shops as $shop)
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="{{ $shop->image }}">
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    ...
                                    <div class="product__item__text">
                                        <h6><a href="{{ route('product.detail', $shop->id) }}">{{ $shop->name }}</a>
                                        </h6>
                                        <h5>{{ $shop->selling_price }}</h5>
                                    </div>
                                </div>
                            </div>
                        @endforeach

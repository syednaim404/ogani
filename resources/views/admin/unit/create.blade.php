                ...
                <div class="card-body">
                    <form action="{{ route('unit.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="code" placeholder="Enter Unit Code"
                                    class="form-control py-3">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" placeholder="Enter Unit Description" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <button type="submite" class="btn btn-primary">Create Unit</button>
                    </form>
                </div>
            </div>
        </div>

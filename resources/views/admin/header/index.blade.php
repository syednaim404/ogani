    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Header</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Header Detail</h3>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($headers as $header)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset($header->image) }}" alt="Logo"
                                                height="60"></td>
                                                <td>{{ $header->mobile }}</td>
                                                <td>{{ $header->description }}</td>
                                        <td>{{ $header->status == 1 ? 'Published' : 'Unpublished' }}</td>
                                        <td>

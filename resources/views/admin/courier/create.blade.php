    ...
    <div class="row row-deck">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('courier.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="email" name="email" placeholder="Enter Courier Email"
                                    class="form-control py-3">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="mobile" placeholder="Enter Courier Mobile Number"
                                    class="form-control py-3">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="address" placeholder="Enter Courier Address" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <button type="submite" class="btn btn-primary">Create Courier</button>
                    </form>
                </div>
            </div>
        </div>

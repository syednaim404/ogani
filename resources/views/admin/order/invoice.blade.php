...
@section('body')
        ...
        <table>
            ...
            @foreach ($order->orderDetails as $orderDetail)
                <tr class="item">
                    ...
                    <td class="text-right">{{ $subTotal = $orderDetail->product_price * $orderDetail->product_qty }}</td>
                </tr>
    ...
    <a href="{{route('admin.order.download.invoice', $order->id)}}" class="btn btn btn-primary my-3">Downlode Invoice</a>
    <a href="{{route('admin.all.order')}}" class="btn btn-gray my-3">Back</a>
@endsection
